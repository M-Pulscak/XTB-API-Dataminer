Defaultní originální Python wrapper (konektor) API `xAPIConnector.py` ze stránek [xStore Developers XTB](http://developers.xstore.pro/api). Zastaralý a nefunkční.  
